...
Відображення ідентифікатора угоди
  ...
  ...      critical
  :FOR  ${username}  IN  ${viewer}  ${tender_owner}
  \   Отримати дані із поля agreements[0].agreementID тендера для користувача ${viewer}
...
Можливість оновити властивості угоди для внесиних змін taxRate
  [Tags]   ${USERS.users['${tender_owner}'].broker}: Внесення зміни
  ...      tender_owner
  ...      ${USERS.users['${tender_owner}'].broker}
  ...      modification
...
Можливість оновити властивості угоди для внесиних змін itemPriceVariation
  [Tags]   ${USERS.users['${tender_owner}'].broker}: Внесення зміни
  ...      tender_owner
  ...      ${USERS.users['${tender_owner}'].broker}
  ...      modification
...
Можливість оновити властивості угоди для внесиних змін thirdParty
  [Tags]   ${USERS.users['${tender_owner}'].broker}: Внесення зміни
  ...      tender_owner
  ...      ${USERS.users['${tender_owner}'].broker}
  ...      modification
...
Можливість оновити властивості угоди для внесиних змін partyWithdrawal
  [Tags]   ${USERS.users['${tender_owner}'].broker}: Внесення зміни
  ...      tender_owner
  ...      ${USERS.users['${tender_owner}'].broker}
  ...      modification
