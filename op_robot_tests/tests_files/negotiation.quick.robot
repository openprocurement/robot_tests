...
Відображення причини вибору переговорної процедури за нагальгою потребою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення причини вибору переговорної процедури за нагальгою потребою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
  Відображення причини вибору закупівлі


Відображення опису причини вибору переговорної процедури за нагальгою потребою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису причини вибору переговорної процедури за нагальгою потребою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
