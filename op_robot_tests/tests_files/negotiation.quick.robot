...
Відображення заголовку переговорної процедури англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку переговорної процедури за нагальною потребою англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення заголовку переговорної процедури російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку переговорної процедури за нагальною потребою російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури за нагальною потребою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури за нагальною потребою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури за нагальною потребою англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури за нагальною потребою англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури за нагальною потребою російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури за нагальною потребою російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення підстави вибору переговорної процедури за нагальгою потребою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення підстави вибору переговорної процедури за нагальгою потребою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення обгрунтування причини вибору переговорної процедури за нагальгою потребою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення обгрунтування причини вибору переговорної процедури за нагальгою потребою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
