...
Відображення заголовку звіту про укладений договір англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку звіту про укладений договір англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення заголовку звіту про укладений договір російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку звіту про укладений договір російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису звіту про укладений договір
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису звіту про укладений договір
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису звіту про укладений договір англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису звіту про укладений договір англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису звіту про укладений договір російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису звіту про укладений договір російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
