...
Отримати дані із тендера
  ...
  Log  ${username}
  Log  ${field_name}
  ${field_name}=  Run Keyword If  '${object_id}'=='${EMPTY}'  Set Variable  ${field_name}
  ...
  ${field_value}=  Run Keyword IF  '${object_id}'=='${EMPTY}'  Run As  ${username}  Отримати інформацію із тендера  ${field_name}
  ...                          ELSE  Отримати дані із об’єкта тендера  ${object_id}  ${field_name}
...
Отримати дані із об’єкта тендера
  ...
  ${field_value}=  Set Variable If  '${object_type}'=='questions'  Run As  ${username}  Отримати інформацію із запитання  ${question_id}  ${field_name}
  [return]  ${field_value}
