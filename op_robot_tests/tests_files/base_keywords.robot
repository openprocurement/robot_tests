...
Звірити відображення типу запланованого тендера
  ${type}=  Отримати дані із плану  ${viewer}  ${TENDER['TENDER_UAID']}  tender.procurementMethodType
  Звірити відображення поля tender.procurementMethodType плану для користувача ${viewer}
  Run keyword if  '${type}' == ''  Run As  ${viewer}  Перевірити наявність повідомлення  "без застосування електронної системи"
