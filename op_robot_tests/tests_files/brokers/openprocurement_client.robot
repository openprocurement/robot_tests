...
Отримати посилання на аукціон для глядача
  ...
  ${value_from_lot_is_not_none}=  Evaluate  not('${None}' == '${lot_auctionUrl}')
  ${auctionUrl}=  Run Keyword If  ${value_from_lot_is_not_none}  Set Variable  ${lot_auctionUrl}
...
Отримати посилання на аукціон для учасника
  ...
  ${value_from_lot_is_not_none}=  Evaluate  not('${None}' == '${lot_participationUrl}')
  ${participationUrl}=  Run Keyword If  ${value_from_lot_is_not_none}  Set Variable  ${lot_participationUrl}
