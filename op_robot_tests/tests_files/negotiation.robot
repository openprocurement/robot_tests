...
Відображення причини вибору переговорної процедури
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення причини вибору переговорної процедури
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
  Відображення причини вибору закупівлі


Відображення опису причини вибору переговорної процедури
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису причини вибору переговорної процедури
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
