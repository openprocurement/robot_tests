...
Відображення заголовку переговорної процедури англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку переговорної процедури англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення заголовку переговорної процедури російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення заголовку переговорної процедури російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури англійською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури англійською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення опису переговорної процедури російською мовою
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення опису переговорної процедури російською мовою
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення підстави вибору переговорної процедури
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення підстави вибору переговорної процедури
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
...
Відображення обгрунтування причини вибору переговорної процедури
  [Tags]  ${USERS.users['${viewer}'].broker}: Відображення обгрунтування причини вибору переговорної процедури
  ...  viewer
  ...  ${USERS.users['${viewer}'].broker}
